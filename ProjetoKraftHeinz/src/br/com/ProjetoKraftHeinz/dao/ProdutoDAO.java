...
public class ProdutoDAO {
    ...
    public void cadastrar(Produto produto){
        ...
        try {
            ...
            stmt.setLong(10, produto.getTipoPeso().getIdTipoPeso());
            stmt.setLong(11, produto.getCategoria().getIdCategoria());
            stmt.setLong(12, produto.getEmbalagem().getIdEmbalagem());
